...
public class ModelStore {
    ...
    public ModelStore() {
        ...
        // In 1.20.1, SpriteAtlasTexture.mipLevel is private with no getter, use game options instead
        int mipLvl = MinecraftClient.getInstance().options.getMipmapLevels().getValue();
