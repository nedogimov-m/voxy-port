...
public class ChunkBoundRenderer {
    ...
    public void render(Viewport<?> viewport) {
        ...
        // 1.20.1 Yarn: getViewDistance().getValue() gives chunks, multiply by 16 for blocks
        final float renderDistance = MinecraftClient.getInstance().options.getViewDistance().getValue()*16;//In blocks
