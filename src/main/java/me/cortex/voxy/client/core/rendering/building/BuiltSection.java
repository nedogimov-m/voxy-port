...
public final class BuiltSection {
    ...
    // Backward-compatible constructor: position only (used by RenderTracker, BuiltSectionMeshCache)
    public BuiltSection(long position) {
        this(position, (byte) 0, -1, null, null, null);
    }

    // Backward-compatible constructor: 4-arg (used by RenderDataFactory)
    public BuiltSection(long position, int aabb, MemoryBuffer geometryBuffer, int[] offsets) {
        this(position, (byte) 0, aabb, geometryBuffer, offsets, null);
    }
