...
public class WorldIdentifier {
    ...
    public String toString() {
        return "WorldIdentifier[" + this.key.getValue().toString() + ", " + this.biomeSeed + ", " + this.dimension.getValue().toString() + ']';
    }
    ...
    public static class GsonAdapter extends TypeAdapter<WorldIdentifier> {
        ...
        public void write(JsonWriter writer, WorldIdentifier identifier) throws IOException {
            writer.beginObject();
            writer.name("key");
            writer.value(identifier.key.getValue().toString());
            writer.name("biomeSeed");
            writer.value(identifier.biomeSeed);
            writer.name("dimension");
            writer.value(identifier.dimension.getValue().toString());
            writer.endObject();
        }
        ...
        public WorldIdentifier read(JsonReader reader) throws IOException {
            ...
            var key = RegistryKey.of(RegistryKeys.WORLD, new Identifier(sKey));
            var dim = RegistryKey.of(RegistryKeys.DIMENSION_TYPE, new Identifier(sDim));
